...
def get_teams() -> list:
    ...
    for teamname in list_of_teams:
        ...
        teams.append(
            team.Team(
                team_index, characters[0], characters[1], characters[2], characters[3]
            )
        )
        ...
        for i in range(4, len(contents)):
            ...
            match task_dets[0]:
                ...
                case (
                    "AscensionTrace"
                ):  # AscensionTrace,Clara,team00000003,3,A2 (or A4 or A6)
                    teams[-1].tasks.append(
                ...
                case (
                    "LevelledTrace"
                ):  # LevelledTrace,Clara,team00000004,4,Basic,8 (or Skill or Ult or Talent)
                    teams[-1].tasks.append(
                ...
                case (
                    "Relic"
                ):  # Relic,Clara,team00000005,5,Musketeer,Head,HP,[atk%,critrate,critdmg,spd]
                    task_substats = []
...
def set_teams(teams: list) -> None:
    ...
    for team in teams:
        ...
        contents = []
        contents.append(
            f'{team.character1["Name"]},{team.character1["Level"]},{team.character1["Weapon"]},{team.character1["WeaponLV"]},{team.character1["A2Trace"]},{team.character1["A4Trace"]},{team.character1["A6Trace"]},{team.character1["BasicLV"]},{team.character1["SkillLV"]},{team.character1["UltLV"]},{team.character1["TalentLV"]}\n'
        )
        contents.append(
            f'{team.character2["Name"]},{team.character2["Level"]},{team.character2["Weapon"]},{team.character2["WeaponLV"]},{team.character2["A2Trace"]},{team.character2["A4Trace"]},{team.character2["A6Trace"]},{team.character2["BasicLV"]},{team.character2["SkillLV"]},{team.character2["UltLV"]},{team.character2["TalentLV"]}\n'
        )
        contents.append(
            f'{team.character3["Name"]},{team.character3["Level"]},{team.character3["Weapon"]},{team.character3["WeaponLV"]},{team.character3["A2Trace"]},{team.character3["A4Trace"]},{team.character3["A6Trace"]},{team.character3["BasicLV"]},{team.character3["SkillLV"]},{team.character3["UltLV"]},{team.character3["TalentLV"]}\n'
        )
        contents.append(
            f'{team.character4["Name"]},{team.character4["Level"]},{team.character4["Weapon"]},{team.character4["WeaponLV"]},{team.character4["A2Trace"]},{team.character4["A4Trace"]},{team.character4["A6Trace"]},{team.character4["BasicLV"]},{team.character4["SkillLV"]},{team.character4["UltLV"]},{team.character4["TalentLV"]}\n'
        )
        ...
        for task in team.tasks:
            match task.tasktype:
                case "Level":
                    contents.append(
                        f"Level,{task.character},{task.uuid},{task.pos},{task.level}\n"
                    )
                case "WeaponLevel":
                    contents.append(
                        f"WeaponLevel,{task.character},{task.uuid},{task.pos},{task.level}\n"
                    )
                case "AscensionTrace":
                    contents.append(
                        f"AscensionTrace,{task.character},{task.uuid},{task.pos},{task.trace}\n"
                    )
                case "LevelledTrace":
                    contents.append(
                        f"LevelledTrace,{task.character},{task.uuid},{task.pos},{task.trace},{task.target}\n"
                    )
                case "Relic":
                    contents.append(
                        f"Relic,{task.character},{task.uuid},{task.pos},{task.set},{task.slot},{task.mainstat}"
                    )
                    for i in range(4):
                        if task.substats[i] != "":
